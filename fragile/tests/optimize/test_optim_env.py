...
@pytest.fixture()
def env():
    return Function(function=lambda x: torch.ones(len(x)), shape=(2,), bounds=[(-10, 10), (-5, 5)])
...
class TestFunction:
    ...
    def test_are_in_bounds(self, env):
        example_1 = torch.tensor([[10, 10], [6, 5], [6, 4], [-11, -6]])
