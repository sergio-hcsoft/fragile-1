...
class EarthSampler(BinarySwap):
    ...
    def __init__(self, force_name: list=None, force_lag: list=None, names: list=None,*args,
                 **kwargs):
    ...
    def sample(self, env_states: States=None, batch_size: int=1,
        ...
        states = super(EarthSampler, self).sample(env_states=env_states, batch_size=batch_size,
                                                  model_states=model_states, **kwargs)
